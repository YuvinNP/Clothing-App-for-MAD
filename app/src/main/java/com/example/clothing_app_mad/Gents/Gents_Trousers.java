...
public class Gents_Trousers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_gents__trousers );

        query = FirebaseDatabase.getInstance().getReference("Product").orderByChild("category").equalTo("GentsTrousers");
                        ...
                        holder.itemView.setOnClickListener( new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (Prevalent.currentOnlineUser == null){
                                    ...
                                    Intent intent = new Intent( Gents_Trousers.this, SellerMaintainProductsActivity.class);
                                    intent.putExtra("pid", product.getPid());
                                    startActivity(intent);
                                }
                                //if it is customer, customer direct to product details activity
                                else{
                                    Intent intent = new Intent(Gents_Trousers.this, ProductDetailsActivity.class);
                                    intent.putExtra("pid", product.getPid());
                                    startActivity(intent);
                                }
                            }

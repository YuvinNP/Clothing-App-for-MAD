...
import com.example.clothing_app_mad.Ladies.Ladies_Tops;
import com.example.clothing_app_mad.Ladies.Ladies_Trousers;
...
public class Gents extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate( R.layout.fragment_gents, container, false);
            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index == 0){
                        ...
                        Intent intent = new Intent(getActivity(), Gents_Shirts.class);
                        startActivity(intent);
                    }
                    else if(index == 1){

                        Intent intent = new Intent(getActivity(), Gents_TShirts.class);
                        startActivity(intent);
                    }
                    else if (index == 2){

                        Intent intent = new Intent(getActivity(), Gents_Trousers.class);
                        startActivity(intent);
                    }
                    else {

                        Intent intent = new Intent(getActivity(), Gents_Shorts.class);
                        startActivity(intent);
                    }
                }
            });

...
public class Gents_Shorts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        query = FirebaseDatabase.getInstance().getReference("Product").orderByChild("category").equalTo("GentsShorts");
                        ...
                        holder.itemView.setOnClickListener( new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (Prevalent.currentOnlineUser == null){
                                    ...
                                    Intent intent = new Intent( Gents_Shorts.this, SellerMaintainProductsActivity.class);
                                    intent.putExtra("pid", product.getPid());
                                    startActivity(intent);
                                }
                                //if it is customer, customer direct to product details activity
                                else{
                                    Intent intent = new Intent(Gents_Shorts.this, ProductDetailsActivity.class);
                                    intent.putExtra("pid", product.getPid());
                                    startActivity(intent);
                                }
                            }

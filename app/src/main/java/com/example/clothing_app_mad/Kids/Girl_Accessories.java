...
import com.example.clothing_app_mad.Gents.Gents_Shirts;
...
public class Girl_Accessories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_girl__accessories );

        query = FirebaseDatabase.getInstance().getReference("Product").orderByChild("category").equalTo("GirlsAccessories");
                        ...
                        holder.itemView.setOnClickListener( new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if (Prevalent.currentOnlineUser == null){
                                    ...
                                    Intent intent = new Intent( Girl_Accessories.this, SellerMaintainProductsActivity.class);
                                    intent.putExtra("pid", product.getPid());
                                    startActivity(intent);
                                }
                                //if it is customer, customer direct to product details activity
                                else{
                                    Intent intent = new Intent(Girl_Accessories.this, ProductDetailsActivity.class);
                                    intent.putExtra("pid", product.getPid());
                                    startActivity(intent);
                                }
                            }

            ...
            cardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (index == 0){
                        ...
                        Intent intent = new Intent(getActivity(), Girl_Kid_Items.class);
                        startActivity(intent);
                    }
                    else if(index == 1){

                        Intent intent = new Intent(getActivity(), Boys_Kid_Items.class);
                        startActivity(intent);
                    }
                    else if (index == 2){

                        Intent intent = new Intent(getActivity(), Girl_Accessories.class);
                        startActivity(intent);
                    }
                    else {

                        Intent intent = new Intent(getActivity(), Boys_Accessories.class);
                        startActivity(intent);
                    }
                }
            });
